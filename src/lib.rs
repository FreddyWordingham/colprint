...
//!
//! This crate provides a simple yet powerful way to format and display data in aligned columns
//! with automatic width calculation and customizable separators. It's designed to make terminal
//! output more readable and organized without the overhead of a full table-formatting library.
